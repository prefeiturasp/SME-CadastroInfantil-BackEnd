...
from cadastro_infantil.users.models import User
from cadastro_infantil.users.tests.factories import UserFactory
from cadastro_infantil.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
