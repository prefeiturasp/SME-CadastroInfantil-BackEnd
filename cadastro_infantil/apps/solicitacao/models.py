...
class Solicitacao(models.Model):
    protocolo = models.CharField(max_length=10, unique=True, help_text="Protocolo automatico")
    dados = models.OneToOneField(DadosCrianca, related_name='dados', on_delete=models.DO_NOTHING)
    exportado = models.BooleanField(default=False, help_text="FALG que esta solicitacao já foi exportada")
