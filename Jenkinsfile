pipeline {
    environment {
      ...
      namespace = "${env.branchname == 'develop' ? 'cadastroinfantil-dev' : env.branchname == 'homolog' ? 'sme-cadastro-infantil' : env.branchname == 'homolog-r2' ? 'sme-cadastro-infantil' : 'sme-cadastro-infantil' }"
    }
